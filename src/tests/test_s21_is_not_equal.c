...
START_TEST(not_equal_positive_float) {
...
START_TEST(not_equal_negative_float) {
...
START_TEST(not_equal_max_vs_min) {
...
START_TEST(not_equal_precision_loss) {
  const char *num1_str = "0.0000000000000000000000000001";
  const char *num2_str = "0.0000000000000000000000000000";
  NEW_DECIMAL(num1, num1_str);
  NEW_DECIMAL(num2, num2_str);
...
Suite *suite_s21_is_not_equal(void) {
  ...
  tcase_add_test(tcase_core, not_equal_positive_float);
  tcase_add_test(tcase_core, not_equal_negative_float);
  ...
  tcase_add_test(tcase_core, not_equal_max_vs_min);
  tcase_add_test(tcase_core, not_equal_precision_loss);
